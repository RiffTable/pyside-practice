...
class GateItem(QGraphicsRectItem):
    ...
    def mousePressEvent(self, event):
        ...
        if item_at_click == self.label:
            ...
            elif event.button() == Qt.RightButton and self.type == "IN":
...
class LogicSimApp(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Logic Sim: Drag Text to Move | Drag Body to Wire")
        ...
        self.ghost_line = self.scene.addLine(0,0,0,0, QPen(Qt.black, 2, Qt.DashLine))
